...
/**
 * Created by yangli on 2016/8/15.
 */
@Service
public class RedisService {
    ...
    public void remove(String keyPattern, Boolean isSuffxKey) {
        ...
        Set<String>
                removeKeys = redisTemplate.keys(finalKey);
...
//        return "java_" + PropertyUtils.getProperty("RedisVersion") + ":"
//                + orginKey;
          return  "java_ssm_"+orginKey;
    }
